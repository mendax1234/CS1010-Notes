...
This idea comes from the exercise we have done, which is in [#problem-2.1](../../tutorial/tut-01.md#problem-2.1 "mention") about finding the maximum number in a list. Here we just use two variables to store the properties of the "largest" structure we want to find.
...
1. Ask what **real numbers** are? Is it good for us to just define them to be `double`in our exam?
2. Include the functino `prime` in your cheatsheet!
